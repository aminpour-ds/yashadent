...
function colleagueCard(item) {
    ...
    return `<div class="col-md-6 col-lg-4 py-3 wow zoomIn">
            <div class="card-doctor">
                ...
                <div class="body">
                <p class="text-xl mb-0" style="direction: rtl; text-align: center;">${item.first_name_fa} ${item.last_name_fa}</p>            
                <div class="text-xl mb-0">                                                        
                    <div style="direction: rtl; text-align: center;">
                    <span class="text-sm text-grey">${item.professionalStatement_fa}</span>
                    </div>
                </div>            
                </div>
            </div>
